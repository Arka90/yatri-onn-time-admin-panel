    ...
    actions: {
        ...
        deleteFaqsById: (id) => {
            set((state) => ({
                ...
                faqManagement: {
                    ...state.faqManagement,
                    faqs: state.faqManagement.faqs.filter(
                        (faq) => faq._id !== id
                    ),
                },
            }));
        ...
        resetTransactions: () => {
            set((state) => ({
                ...
                transactionManagement: {
                    ...state.transactionManagement,
                    transactions:
                        initialState.transactionManagement.transactions,
                },
            }));
        },
        ...
        resetAdvertisements: () => {
            set((state) => ({
                ...
                advertisementManagement: {
                    ...state.advertisementManagement,
                    advertisements:
                        initialState.advertisementManagement.advertisements,
                },
            }));
        },
        ...
        deleteAdvertisemenById: (advertisementId) => {
            set((state) => ({
                ...
                advertisementManagement: {
                    ...state.advertisementManagement,
                    advertisements:
                        state.advertisementManagement.advertisements.filter(
                            (advertisement) =>
        ...
        resetSubcriptions: () => {
            set((state) => ({
                ...
                subscrptionManagement: {
                    ...state.subscrptionManagement,
                    subscriptions:
                        initialState.subscrptionManagement.subscriptions,
                },
            }));
        },
        ...
        deleteSubcriptionsById: (subscriptionId) => {
            set((state) => ({
                ...
                subscrptionManagement: {
                    ...state.subscrptionManagement,
                    subscriptions:
                        state.subscrptionManagement.subscriptions.filter(
                            (subscription) =>
